...
files=os.listdir("/home/lokin/HOG_feature_descriptor_images")
label=os.listdir("/home/lokin/label_images/label_images")
label_t=[]
with open("traindata.csv",'w') as csvfile:
    featurewriter=csv.writer(csvfile)
    for i in range(0,len(files)):
        img=imread(os.path.join("/home/lokin/HOG_feature_descriptor_images",files[i]))
        label_img=imread(os.path.join("/home/lokin/label_images/label_images",label[i]))
