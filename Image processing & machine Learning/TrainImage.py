...
files=os.listdir("D://Lokin//Data Analytics//TOMTOM//Images//HOG feature descriptor images")
label=os.listdir("D://Lokin//Data Analytics//TOMTOM//Images//label_images")
label_t=[]
with open("traindata.csv",'w',newline='') as csvfile:
    featurewriter=csv.writer(csvfile)
    for i in range(0,len(files)):
        img=imread(os.path.join("D://Lokin//Data Analytics//TOMTOM//Images//HOG feature descriptor images",files[i]))
        label_img=imread(os.path.join("D://Lokin//Data Analytics//TOMTOM//Images//label_images",label[i]))
...
# rf_model=RandomForestClassifier(n_estimators=2000,criterion='gini',min_samples_split=2, min_samples_leaf=1,max_features='auto',bootstrap='True')
...
# df=read_csv("C://Users//Lokin//Desktop//TOMTOM//traindata.csv",names=arange(145),header=None)
# print(df)
# df=np.array(df)
...
#     pickle.dump(df[:,144],pickle_file)
